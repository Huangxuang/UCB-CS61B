...
public class IntList {
    ...
    /**Reverse the item in the IntList, destructive.*/
    public static IntList reverse(IntList L) {
        ...
        while (res != null) {
            IntList temp = res.rest;
            res.rest = L;
            L = res;
            res = temp;
        }

        /* Second iteration method using dummy node
        IntList sentinel = new IntList(0,L);
        IntList temp = L.rest;
        L.rest = null;
        while (temp != null){
    ...
    /**Reverse the item in the IntList, destructive, using recursive method.*/
    public static IntList reverseRecursive(IntList L) {
        if (L == null || L.rest == null) {
            return L;
        } else {
            IntList endOfReversed = L.rest;
            IntList reversed = reverseRecursive(L.rest);
            endOfReversed.rest = L;
            L.rest = null;
            return reversed;
        }
