...
public class SimpleOomage implements Oomage {
     ...
     * 1. if same memory location: a == b
     * 2.if same type of object, check if all the altributes are the same
     * 4. if the object compared to is null
     * */
    public boolean equals(Object o) {
        ...
        return (temp.red == this.red && temp.blue == this.blue
        && temp.green == this.green);
    }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            //Set the r, g and b as three bit, base = 255;
            int base = 255;
            int hashCode = this.blue / 5 * 1 + this.green / 5 * base
                    + this.red / 5 * base * base;
            return hashCode;
        }
    }
